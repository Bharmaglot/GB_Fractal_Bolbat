...
public class Fractal : MonoBehaviour
{
    ...
    private struct UpdateFractalLevelJob : IJobFor
    {
        ...
        public void Execute(int index)
        {
            ...
            part.WorldRotation = part.Rotation * Quaternion.Euler(0f, part.SpinAngle, 0f);
            part.WorldPosition = parent.WorldPosition + parent.WorldRotation * (_positionOffset * Scale * part.Direction);
            Debug.Log($" {part.SpinAngle} !!! {(part.Rotation * Quaternion.Euler(0f, part.SpinAngle, 0f)).y}");
